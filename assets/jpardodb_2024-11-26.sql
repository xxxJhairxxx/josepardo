...
CREATE TABLE `blog_posts` (
  ...
  KEY `blog_posts_created_by_id_fk` (`created_by_id`),
  KEY `blog_posts_updated_by_id_fk` (`updated_by_id`),
  CONSTRAINT `blog_posts_created_by_id_fk` FOREIGN KEY (`created_by_id`) REFERENCES `admin_users` (`id`) ON DELETE SET NULL,
  CONSTRAINT `blog_posts_updated_by_id_fk` FOREIGN KEY (`updated_by_id`) REFERENCES `admin_users` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `blog_posts_components`
--

DROP TABLE IF EXISTS `blog_posts_components`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `blog_posts_components` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `entity_id` int unsigned DEFAULT NULL,
  `component_id` int unsigned DEFAULT NULL,
  `component_type` varchar(255) DEFAULT NULL,
  ...
  `order` double unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `blog_posts_unique` (`entity_id`,`component_id`,`field`,`component_type`),
  KEY `blog_posts_field_index` (`field`),
  KEY `blog_posts_component_type_index` (`component_type`),
  KEY `blog_posts_entity_fk` (`entity_id`),
  CONSTRAINT `blog_posts_entity_fk` FOREIGN KEY (`entity_id`) REFERENCES `blog_posts` (`id`) ON DELETE CASCADE
...
--
-- Table structure for table `components_footer_footers`
--

DROP TABLE IF EXISTS `components_footer_footers`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `components_footer_footers` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `text` longtext,
  `copyright` varchar(255) DEFAULT NULL,
  `lbl_siguenos` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-11-26 20:58:48
