...
const Whatsapp = () => {
    const { general: { Whatsapp } } = useGenerals();
    ...
    const handleWhatsappMessage = () => {
        const message = noteText.trim() !== '' ? noteText : Whatsapp.mensaje_wsp + '👋';

        // const whatsappUrl = `https://api.whatsapp.com/send?phone=922692354&text=${encodeURIComponent(message)}`;


        window.open(Whatsapp.enlace_invitacion, '_blank');
    ...
    return (
        <>
            <svg xmlns="http://www.w3.org/2000/svg"
                ...
                fillRule="evenodd"
                clipRule="evenodd"
                className='fixed z-[9998] bottom-[3rem] right-[3rem] cursor-pointer transition-all hover:scale-[110%] '
            >
                <path
                    fill="#fff"
